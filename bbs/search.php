...
<tr>
<td align="left"><?php print $T_search_title; ?>:</td>
<td align="right">
<?php 
$PAGE_SIZE = 50;
...
function getSearchCount() {
    ...
    $k = db_encode( "%" . U_REQUEST('k') . "%" );

    $query = "SELECT COUNT(ID) as ct FROM $forum_tbl WHERE (keywords like $k OR title like $k OR body like $k) $use_hidden";
...
FROM $forum_tbl WHERE (keywords like $k OR title like $k OR body like $k) $use_hidden
