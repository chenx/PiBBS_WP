...
<tr>
<td align="left"><?php print $T_digest_area; ?></td>
<td><br/></td>
<td align="right">
<?php 
$PAGE_SIZE = 50;
$cls_page = new ClsPage(getDigestCount(), U_REQUEST_INT('p'), $PAGE_SIZE, 10, "p", $_LANG);
...
function getDigestCount() {
    ...
    $query = "SELECT COUNT(ID) as ct FROM $forum_tbl WHERE digested = '1' $use_hidden";
...
FROM $forum_tbl WHERE digested = '1' $use_hidden
